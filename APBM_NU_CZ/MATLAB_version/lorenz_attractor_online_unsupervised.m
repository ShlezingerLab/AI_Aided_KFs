...
for i_data = 1:10
    ...
    file_name = ['data/test_x_', num2str(i_data), '.csv']; % The csv file is generated by the Python 
                                 % script from the dataset in the parent folder
                                 % Please check "data/load_data.py" for details
