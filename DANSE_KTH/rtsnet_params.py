# Code borrowed from https://github.com/KalmanNet/RTSNet_TSP/blob/master/Simulations/Lorenz_Atractor/parameters.py 
# For the purpose of a consistent comparison, credit to the original authors
